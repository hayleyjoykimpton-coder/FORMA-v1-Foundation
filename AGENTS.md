...
- Meal photo AI: gallery upload (no forced camera). Manual macros remain the reliable path; AI is optional owner-funded via `OPENAI_API_KEY` until Pro is built.
