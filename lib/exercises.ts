...
const DEFINITIONS: ExerciseDefinition[] = [
  ...
  },
  {
    ...
    repRange: { min: 10, max: 12 },
    restSeconds: 45,
    coachingCues: ["Rotate through the ribs, not the arms", "Keep hips square", "Control both directions"],
    commonMistakes: ["Twisting from the lower back", "Using too much arm pull"],
    substitutions: ["pallof_press", "russian_twist"],
  },
  {
    id: "russian_twist",
    name: "Russian Twist",
    ...
    equipment: "dumbbell",
    difficulty: "beginner",
    repRange: { min: 12, max: 16 },
    restSeconds: 40,
    coachingCues: ["Lean back slightly with a long spine", "Rotate the ribcage", "Touch the weight beside each hip"],
    commonMistakes: ["Rounding the lower back", "Moving only the arms"],
    substitutions: ["cable_woodchop", "pallof_press"],
  },
  {
    id: "weighted_crunch",
    ...
    repRange: { min: 12, max: 15 },
    restSeconds: 40,
    coachingCues: ["Hold a plate or dumbbell at the chest", "Curl the ribs toward the hips", "Slow eccentric"],
    commonMistakes: ["Yanking the neck", "Using hip flexors only"],
    substitutions: ["cable_crunch", "hanging_knee_raise"],
  },
